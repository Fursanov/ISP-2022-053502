...
a=[]
a.append(dict(int_list=[1, 2, 3],str_list=['a', 'b', 'c'],dick=dict([('1',2)]),text='string',number=3.44,boolean=True,none=None))
a.append([[1, 2, 3],['a', 'b', 'c'],dict([('1',1),('2',2)]),'string',3.44,True,None])
a.append([[1, 2, 3],3.44,['a', 'b', 'c'],True,dict([('1',1),('2',2)]),'string',None])
a.append(dict(int_list=[1, 2, 3],number=3.44,str_list=['a', 'b', 'c'],boolean=True,dick=dict([('1',2)]),text='string',none=None))
