...
def dumps(a, str_name=''):
    ...
    """принимает объект и имя объекта."""
    string = str_name
    if string != '':
        string += ' = '
...
def get_name(a, str_name=''):
    """Функция выдает имя переменной из строки."""
...
def dump(a, file, str_name=''):
    ...
    """принимает объект, имя файла и имя переменной."""
    with open(file, 'w') as outfile:
        outfile.write(dumps(a, str_name))
